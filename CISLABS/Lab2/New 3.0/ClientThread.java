...
class ClientThread implements Runnable{
	...
	public void run(){
		...
		if(serverMessage == null){
			...
			System.exit(1);
		}else if(serverMessage.equals("KILLEDBYADMIN:")){
			System.out.println("You have been killed by admin");
			System.exit(1);
		}
	...
	public static void main(String args[]) throws Exception {
		...
		System.out.println("Type cmd close to exit."+ "\n To message everyone just type \n commands are:KILLUSER:, ALLUSERS:, CREATEGROUP:, LEAVEGROUP:, JOINGROUP, GROUPSEND, USERSEND: ");
