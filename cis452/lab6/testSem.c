...
int main(){
    ...
    (void) fprintf(stderr, "\nsemget: Setting up seamaphore: semget\n");
    ...
    { /* child */
        ...
        if ((j = semop(semid, sops, nsops)) == -1) {
            ...
            sleep(1); /* DO Nothing for 5 seconds */
            ...
            if ((j = semop(semid, sops, nsops)) == -1) {
                ...
                (void)fprintf(stderr, "Child Process Giving up Control of Track\n");
            sleep(1); /* halt process to allow parent to catch semaphor change first */
        }
    }else{ /* parent */
        nsops = 2;
        ...
        else 
        {
            ...
            (void) fprintf(stderr, "Parent Process Taking Control of Track\n");
            sleep(1); /* Do nothing for 5 seconds */
            ...
            if ((j = semop(semid, sops, nsops)) == -1) {
                ...
                (void) fprintf(stderr, "Parent Process Giving up Control of Track\n");
